...
У Алисы не всегда получается распознать слово «Вампус». Получается то «вантус», то «компас», то «памперсы». Поэтому фразу «Алиса, сыграем в Охоту на&nbsp;Вампуса» нужно произносить максимально четко. Или просто напечатать, чтобы потом запускать по кнопке.
