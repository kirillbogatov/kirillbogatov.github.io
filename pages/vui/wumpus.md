...
Когда игрок находится рядом с Вампусом и промахивается, Вампус начинает паниковать и перемещается в одну из трех своих соседних комнат. В одном случае из трёх он бежит в комнату с игроком. В этом случае игрок либо умирает, либо перемещается в случайную комнату с помощью летучей мыши.

Иногда рандом приводит к курьезным ситуациям. Покажу на примере.

![Почти удачное спасение](/images/posts/wumpus-escape-plan.jpg)

1. Находясь в комнате 18, игрок услышал звуки Вампуса (из 19) и сквозняка (из 9). Чтобы проверить обстановку, игрок стреляет в комнату 9.

2. Услышав звук выстрела, Вампус метнулся в одну из соседних комнат. К несчастью, это оказалась комната 18.

3. Игроку повезло - его схватила летучая мышь и перенесла в комнату 7.
...
При запуске игра иногда выдает сообщение «Диалог не отвечает». Поговаривают, что это баг Алисы. В этом случае достаточно сказать «Давай заново» или «Вернись в меню».
