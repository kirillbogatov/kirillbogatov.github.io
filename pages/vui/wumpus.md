...
Чтобы усилить восторг от прохождения игры я добавил в неё несколько достижений. Вот несколько нетривиальных примеров:

* *Лентяй* — за победу не выходя из стартовой комнаты.
* *Неосмотрительный* — если игрок упал в яму в первые три хода.
* *Осторожный* — за правильное распознавание трёх ловушек.
* *Мститель* — за победу после чудестного спасения от Вампуса.
* *Мышелов* — за три перемещения на летучих мышах.
* *Выживший* — за убийство Вампуса последней стрелой.

![Достижения](/images/posts/wumpus-achivments.jpg)<br>
*<sub>Достижения в конце игры</sub>*

Т.к. в основе игры лежит естественный диалог, я также добавил пару ачивок, завязанных на репликах игрока:
