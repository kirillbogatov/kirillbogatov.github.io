...
Каждый звук в игре выполняет определенную функцию — предупреждают об опасности или задают атмосферу. Так, например, звук натяжения тетевы создает небольшую напряженную паузу между репликой игрока и оглашением результата выстрела.

Интересным решением стал звук зажигания факела в конце некоторых реплик рассказчика. С одной стороны, это добавило в игру чуть больше контекста — в комнатах темно и сыро, поэтому нужно периодически обновлять факелы. С другой стороны, помогло отделить друг от друга несколько реплик рассказчика, не прибегая к длинным паузам (которые нужны пользователям для того, чтобы успеть осмыслить происходящее и подготовиться к следующей порции информации).
