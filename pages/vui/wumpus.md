...
#### Активационная фраза
У Алисы редко получается распознать слово «Вампус». Вместо него получается то «вантус», то «компас», то «памперсы». Поэтому фразу  «Алиса, сыграем в Охоту на Вампуса» нужно произносить максимально четко. Или просто напечатать.
